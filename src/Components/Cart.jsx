...
const Cart = () => {
    ...
    return (
        ...
        <section className="bg-slate-300 py-5">
            ...
            <button onClick={handleClearCart} className="m-auto block mt-5 text-white ring-4 ring-red-500 bg-sky-600 w-6/12 py-3 font-bold text-xl rounded-lg">Clear Cart</button>
        </section>
        {
        cartItems.length > 0 ?
