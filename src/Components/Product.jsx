...
const Product = ({item}) => {
    ...
    return (
        <>
        <article className="w-11/12 xm:w-8/12 tm:w-full m-auto rounded-xl border-2 border-gray-200 bg-white px-3 py-6 hover:scale-105">
            ...
            <p className="font-bold text-center mt-2"><span className="text-rose-500 font-bold">Total Price: </span>{item.price * item.number}$</p>
